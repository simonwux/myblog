...
if (!empty($_POST['sub'])) {
    ...
    $sql= "insert into blog values(null,'0','$title',now(),'$con','$user')";
    mysql_query($sql);
    echo "insert success!";
...
<form action="add.php" method="post">
    <font size="6" color="white">title   :<br></font>
    <br><br>
     <input style="width:550px;height:40px;font-size:25px" type="text" name="title"><br><br>
    <font size="6" color="white">contents:</font>
    <br><br>
    <textarea  style="width:550px;height:450px;font-size:25px" cols="80" name="con"></textarea><br><br>
