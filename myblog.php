...
<Br></Br> 
    	<div class="content_box">
            <h1>Search <span>My Blogs</span></h1>
...
{
	die('<font size="4" color="white">'.'not logged in'.'</font><br><br>');
}
include("conn.php"); //引入连接数据库
    ...
    $sql ="select * from blog where user = '".$user."' AND $w order by id desc limit 5";
    //echo $sql;
