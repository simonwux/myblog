...
<font-size="6" color="white"><h2>title: <?php echo $rs['title']; ?> </h1></font>
<font size="4" color="white">date: <?php echo $rs['date']; ?>  
hits: <?php echo $rs['hits']; ?> owner: <?php echo $rs['user']; ?></font><br><br>
<p><font size="4" color="white">contents:<?php echo $rs['contents']; ?></font></p>
</font>
<br><br>    
